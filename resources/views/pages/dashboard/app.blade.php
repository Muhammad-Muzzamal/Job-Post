...
<body
  ...
  <!-- ===== Preloader Start ===== -->
       @include('pages.dashboard.preloader')
    ...
    <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
      ...
      <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html">
          ...
          <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="{{ asset('dashboardAssets/images/logo/logo2.jpg')}}"
            alt="Logo" />
        </a>
      </div>
      <!-- SIDEBAR HEADER -->
  ...
  <script src="{{ asset('dashboardAssets/js/index.js') }}"></script>
